...
const localizationOptions = [
    { country: 'Canada', currency: 'CAD $', flag: 'https://cdn.shopify.com/static/images/flags/ca.svg?format=jpg&width=60' },
    { country: 'France', currency: 'EUR €', flag: 'https://cdn.shopify.com/static/images/flags/fr.svg?format=jpg&width=60' },
    { country: 'Germany', currency: 'EUR €', flag: 'https://cdn.shopify.com/static/images/flags/de.svg?format=jpg&width=60' },
    { country: 'Hong Kong SAR', currency: 'HKD $', flag: 'https://cdn.shopify.com/static/images/flags/hk.svg?format=jpg&width=60' },
    { country: 'Italy', currency: 'EUR €', flag: 'https://cdn.shopify.com/static/images/flags/it.svg?format=jpg&width=60' },
    { country: 'Japan', currency: 'JPY ¥', flag: 'https://cdn.shopify.com/static/images/flags/jp.svg?format=jpg&width=60' },
    { country: 'South Korea', currency: 'KRW ₩', flag: 'https://cdn.shopify.com/static/images/flags/kr.svg?format=jpg&width=60' },
    { country: 'Spain', currency: 'EUR €', flag: 'https://cdn.shopify.com/static/images/flags/es.svg?format=jpg&width=60' },
    { country: 'United Kingdom', currency: 'GBP £', flag: 'https://cdn.shopify.com/static/images/flags/gb.svg?format=jpg&width=60' },
    { country: 'United States', currency: 'USD $', flag: 'https://cdn.shopify.com/static/images/flags/us.svg?format=jpg&width=60' },
];

const Footer: React.FC = () => {
    const [isDropdownOpen, setIsDropdownOpen] = useState(false);
    const [selectedLocale, setSelectedLocale] = useState(localizationOptions[9]); // Default to US
    ...
    const handleSelectLocale = (locale: typeof localizationOptions[0]) => {
            ...
            <div className="container">
                <div className="footer__inner">
                    ...
                    <div className="footer__aside">
                        <div className="localization-selectors" ref={dropdownRef}>
                            <div className="relative">
                                <button
                                    type="button"
                                    className="localization-toggle heading text-xxs link-faded"
                                    aria-label="Change country or currency"
                                    onClick={handleToggleDropdown}
                                >
                                    <img src={selectedLocale.flag} alt={selectedLocale.country} width="20" height="15" className="country-flag" />
                                    ...
                                    <svg
                                        ...
                                        fill="none"
                                        width="10"
                                        className={`icon icon-chevron-down ${isDropdownOpen ? 'icon--rotated' : ''}`}
                                        viewBox="0 0 10 10"
                                    >
                                ...
                                {isDropdownOpen && (
                                    <div className="localization-dropdown">
                                        <ul className="unstyled-list" role="list">
                                            {localizationOptions.map((locale) => (
                                                <li key={locale.country}>
                                                    <button
                                                        type="button"
                                                        className={`localization-dropdown__item ${selectedLocale.country === locale.country ? 'is-selected' : ''}`}
                                                        onClick={() => handleSelectLocale(locale)}
                                                    >
                                                        <img src={locale.flag} alt={locale.country} width="20" height="15" className="country-flag" />
                                                        <span className="text-xxs">{locale.country} ({locale.currency})</span>
                                                    </button>
                                                </li>
                                            ))}
                                        </ul>
                        ...
                        <ul className="payment-methods unstyled-list">
                            ...
                            <li>
                                <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-diners_club">
                                    ...
                                    <path opacity=".07" d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"></path>
                                    <path fill="#fff" d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32"></path>
                                    <path d="M12 12v3.7c0 .3-.2.3-.5.2-1.9-.8-3-3.3-2.3-5.4.4-1.1 1.2-2 2.3-2.4.4-.2.5.2.5.2V12zm2 0V8.3c0-.3 0-.3.3-.2 2.1.8 3.2 3.3 2.4 5.4-.4 1.1-1.2 2-2.3 2.4-.4.2-.4.1-.4-.2V12zm7.2-7H13c3.8 0 6.8 3.1 6.8 7s-3 7-6.8 7h8.2c3.8 0 6.8-3.1 6.8-7s-3-7-6.8-7z" fill="#3086C8"></path>
                                </svg>
                            </li>
                            <li>
